		...
		>
			...
			{confirmDeleteId && (
				<div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm">
					<div className="bg-white p-6 rounded-lg shadow-lg border border-gray-300 max-w-sm sm:max-w-md w-full">
						<h2 className="text-lg text-gray-800 text-center font-semibold">
