			...
			<div className="space-y-4">
				<div>
					...
					<input
						type="text"
						id="voucher"
						className="block w-full rounded-lg border border-gray-400 bg-gray-200 
            p-2.5 text-sm text-black placeholder-gray-600 focus:border-gray-900 
            focus:ring-gray-900"
				...
				<motion.button
					type="button"
					className="flex w-full items-center justify-center rounded-lg bg-black px-5 py-2.5 text-sm font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-600"
